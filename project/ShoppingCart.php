    ...
    <div class="pageContainer">
        ...
        <section>
            <div class="content">
                ...
                <td>$qty</td>
                <td class='bookPrice'> " . asDollars($price * .8) . "</td>
                <td class='bookPrice'>" . asDollars(($price * $qty) * .8) . "</td>
                <td align='center'>
                    ...
                    echo "<table class='cartTotal'>
                      <tbody><tr>
                        <td> Sub-Total:</td>
                        <td align='right'>" . asDollars($subtotal * .8) . " </td>
                      </tr>
                          <tr>
                        <td> Shipping:*</td>
                        <td align='right'> $";
                    if (!$noBooks && isset($bookArray)) {
          ...
          <tr>
            ...
            <td align='right'><b> ";
                    if ($totalbooks > 0) {
                        echo asDollars((($subtotal * .8) + 5) + (3 * ($totalbooks - 1)));
                    } else {
                        echo "$0.00";
                    }
                    ...
                    <div class="cartIcons">
                        ...
                        <a href="checkout01.php"> <img border="0"
                                                       src="img/proceed-to-checkout.gif"
                                                       width="183" height="31" alt="Proceed to checkout"></a>
                        <? if ($totalbooks >= 1) {
                            echo " <br><a href='?deleteAll=1'>Remove all books?</a>";
                        } ?>
                    </div>
                    <p id="shipping">* Shipping is $5.00 for the first book and $3.00 for each additional book. To
                        assure
