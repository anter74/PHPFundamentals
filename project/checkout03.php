    ...
    ?>
        <table id="cart">
            ...
            if (count($bookArray) <= 0) {
                ...
                $message .= "</head>\n";
                $message .= "<body>\n";
                $message .= "<img src='http://yorktown.cbe.wwu.edu/students/162/behrndc/project/img/logo.png'>";
                ...
                $message .= "    </tr>\n";
                $message .= "</table>\n";
                $message .= "<p>Something look wrong? <a href=\"http://yorktown.cbe.wwu.edu/students/162/behrndc/project/checkout01.php\">Change it here!</a> </p>\n";
                $message .= "</body>\n";
                $message .= "</html>";
                ...
                $message .= "<br>\n";
                $message .= "<p>Shipped to: ";
                $message .=  "<p>$fname $lname </p><p>$street </p><p>$city, $state $zip</p>";
                $message .= "<table>\n";
                $message .= "    <tr>\n";
                $message .= "        <th>Title</th>\n";
                $message .= "        <th>Qty</th>\n";
                ...
                $message .= "    </tr>\n";
                $message .= "</table>\n";
                $message .= "<p><a href=\"http://yorktown.cbe.wwu.edu/students/162/behrndc/project/index.php\">Thanks for shopping with us and come again!</a></p>\n";
                $message .= "</body>\n";
                $message .= "</html>";
        ...
        <div class='cartIcons'>
            ...
            <a href='index.php'>
                <img border='0' src='/sandvig/mis314/assignments/bookstore/images/continue-shopping.gif'
                     ...
                     height='19'></a><br>
            <br>
            <a href='OrderHistory.php?custIDe=<? echo urlencode(encrypt($custID, $myPassword)); ?>'>View
