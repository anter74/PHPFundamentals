...
<head>
    ...
    <title>Order History - GeekBooks</title>
    ...
    <section>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<div class=\"bookHistory\">
                    <a href=\"ProductPage.php?isbn=$isbn\"><img class=\"History\" width='50px' src=\"/sandvig/mis314/assignments/bookstore//bookimages/$isbn.01.THUMBZZZ.jpg\" alt=\"L\">
                  </a>                 
                 <b>Order ID: $orderID</b>&nbsp;&nbsp;
                   " . date('  F j Y g:i A', $orderDate) . "</span><br>
                   <a href='ProductPage.php?isbn=$isbn' style='color: #7DA235;'>$title</a><br>
                  Qty: $qty  Price: " . asDollars($price * $qty) . "<br><br>
         </div>";
        }
        ?>
    </section>
