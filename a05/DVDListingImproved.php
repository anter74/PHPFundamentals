...
<div class="pageContainer centerText">
    ...
    //List records
    $sql = "SELECT  a.ASIN, a.title, a.price, b.actorID, GROUP_CONCAT( Concat( FName, \" \", LName ) SEPARATOR \", \" ) AS Name FROM dvdtitles a, dvdactorstitles ab, dvdactors b  WHERE a.ASIN = ab.ASIN AND b.actorID = ab.actorID GROUP BY ab.ASIN;";
