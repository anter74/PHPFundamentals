...
<head>
    ...
    <link rel="stylesheet" href="http://yorktown.cbe.wwu.edu/sandvig/mis314/assignments/bookstore/StyleSheet.css"
          type="text/css"/>
</head>
<body>
...
<span class='bookTitle'> $title </span><br />
        ...
        <p> $description </p>                <a href='ShoppingCart.php?addISBN=$isbn'>
            <img border='0' src='/sandvig/mis314/assignments/bookstore/images/add-to-shopping-cart-blue.gif' align='right'>
        </a>
        ";
        }
        ?>
